...
benchmark(decision_tree_model, X_train, X_test, y_train, y_test, 'Decision Tree Classifier')
drawPlots(decision_tree_model, X_train, X_test, y_train, y_test, 'Decision Tree Classifier')
